...
public class IAController { // BW4TAgent
    ...
    public IAController() throws Exception{ // is rmi safe?
		/*
         try {
       ...
       try {
        ...
        try{
            ...
            parent = (ColorInterface) Naming.lookup("interface");
        }catch(Exception e){
            System.err.println("Exception: Failed to connect to Color");
            e.printStackTrace();
        }
        seq = getSequence();
    }
                ...
                if(name.equals("color")|| name.equals("")){
                    ...
                    */
                    if(p.toProlog().contains(target)){
                        ...
                        routinPutDown();
                        try{
                            System.out.println(parent.getCurrent());
                            setTarget(seq[parent.getCurrent()]);
                        }catch(Exception e){
                            target=null;
                            break;
                        }
    ...
    public void routinPutDown() throws Exception{
        putDown();
        parent.putBox(colorInHand);
        colorInHand=null;
        System.out.println(colorInHand);
        System.out.println(onColor);
    }
    ...
    public void handleAction(String action) throws Exception{
