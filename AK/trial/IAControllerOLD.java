...
public class IAControllerOLD { // BW4TAgent
    ...
    public IAControllerOLD() { // is rmi safe?
		/*
         try {
    ...
    public void getPercepts() {
        try {
            LinkedList<Percept> ll = env.getAllPerceptsFromEntity(bot);
    ...
    public static void main(String[] args) {
        ...
        IAControllerOLD controller = new IAControllerOLD();
